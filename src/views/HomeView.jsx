    ...
    return (
        <div className="flex flex-col justify-start items-center scrollbar-hide h-full w-full gap-4 overflow-y-scroll pb-24">
            ...
            <div className="text-title font-bold text-3xl sm:text-4xl md:text-6xl my-4 pt-4 rounded-full text-primary relative w-full flex items-center justify-center">
                <div className="flex flex-col items-center text-white" onClick={clickDev}>
                    <span className=" title-shadow">DR. KABOOM</span>
                    <span className="text-neutral text-normal text-xs font-light mt-2">Adaptation of Dr. Boom&trade;</span>
                </div>
            ...
            <div className="flex w-full flex-col items-center gap-8 scrollbar-hide">
                <Box>
                    ...
                    <button id="join_btn" className={"btn transition-all bg-primary " + (loading ? " bg-primary text-primary-content btn-wide opacity-75 " : " btn-primary opacity-100 btn-wide ")} onClick={() => joinRoom()}>JOIN</button>
